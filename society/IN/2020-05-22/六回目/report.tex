...
\includegraphics[width=0.5\hsize]{num-norm_comp-eucl-ward-8-timezone.pdf}
}~
\subfigure[曜日での分類（区間データ数）]{
\includegraphics[width=0.5\hsize]{num-norm_comp-eucl-ward-8-day.pdf}
}\\
\subfigure[時間帯での分類（比率）]{
...
\begin{center}
\subfigure[時間帯での分類（区間データ数）]{
\includegraphics[width=0.5\hsize]{num-diff_comp-eucl-ward-4-timezone.pdf}
}~
\subfigure[曜日での分類（区間データ数）]{
\includegraphics[width=0.5\hsize]{num-diff_comp-eucl-ward-4-day.pdf}
}\\
\subfigure[時間帯での分類（比率）]{
